...
var (
	md_ClaimFunds                   protoreflect.MessageDescriptor
	fd_ClaimFunds_recipient_address protoreflect.FieldDescriptor
	fd_ClaimFunds_amount            protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_protocolpool_v1_budget_proto_init()
	md_ClaimFunds = File_cosmos_protocolpool_v1_budget_proto.Messages().ByName("ClaimFunds")
	fd_ClaimFunds_recipient_address = md_ClaimFunds.Fields().ByName("recipient_address")
	fd_ClaimFunds_amount = md_ClaimFunds.Fields().ByName("amount")
}

var _ protoreflect.Message = (*fastReflection_ClaimFunds)(nil)

type fastReflection_ClaimFunds ClaimFunds

func (x *ClaimFunds) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ClaimFunds)(x)
}

func (x *ClaimFunds) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ClaimFunds_messageType fastReflection_ClaimFunds_messageType
var _ protoreflect.MessageType = fastReflection_ClaimFunds_messageType{}

type fastReflection_ClaimFunds_messageType struct{}

func (x fastReflection_ClaimFunds_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ClaimFunds)(nil)
}
func (x fastReflection_ClaimFunds_messageType) New() protoreflect.Message {
	return new(fastReflection_ClaimFunds)
}
func (x fastReflection_ClaimFunds_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ClaimFunds
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ClaimFunds) Descriptor() protoreflect.MessageDescriptor {
	return md_ClaimFunds
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ClaimFunds) Type() protoreflect.MessageType {
	return _fastReflection_ClaimFunds_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ClaimFunds) New() protoreflect.Message {
	return new(fastReflection_ClaimFunds)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ClaimFunds) Interface() protoreflect.ProtoMessage {
	return (*ClaimFunds)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ClaimFunds) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.RecipientAddress != "" {
		value := protoreflect.ValueOfString(x.RecipientAddress)
		if !f(fd_ClaimFunds_recipient_address, value) {
			return
		}
	}
	if x.Amount != nil {
		value := protoreflect.ValueOfMessage(x.Amount.ProtoReflect())
		if !f(fd_ClaimFunds_amount, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ClaimFunds) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		return x.RecipientAddress != ""
	case "cosmos.protocolpool.v1.ClaimFunds.amount":
		return x.Amount != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.protocolpool.v1.ClaimFunds"))
		}
		panic(fmt.Errorf("message cosmos.protocolpool.v1.ClaimFunds does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimFunds) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		x.RecipientAddress = ""
	case "cosmos.protocolpool.v1.ClaimFunds.amount":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ClaimFunds) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		value := x.RecipientAddress
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.protocolpool.v1.ClaimFunds does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimFunds) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		x.RecipientAddress = value.Interface().(string)
	case "cosmos.protocolpool.v1.ClaimFunds.amount":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimFunds) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.amount":
		if x.Amount == nil {
	...
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		panic(fmt.Errorf("field recipient_address of message cosmos.protocolpool.v1.ClaimFunds is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.protocolpool.v1.ClaimFunds"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ClaimFunds) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.ClaimFunds.recipient_address":
		return protoreflect.ValueOfString("")
	case "cosmos.protocolpool.v1.ClaimFunds.amount":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ClaimFunds) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.protocolpool.v1.ClaimFunds", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ClaimFunds) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ClaimFunds) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ClaimFunds) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ClaimFunds) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ClaimFunds)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ClaimFunds: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ClaimFunds: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ClaimFunds) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimFunds) ProtoMessage() {}

// Deprecated: Use ClaimFunds.ProtoReflect.Descriptor instead.
func (*ClaimFunds) Descriptor() ([]byte, []int) {
	return file_cosmos_protocolpool_v1_budget_proto_rawDescGZIP(), []int{2}
}

func (x *ClaimFunds) GetRecipientAddress() string {
	if x != nil {
		return x.RecipientAddress
	}
	return ""
...
func (x *ClaimFunds) GetAmount() *v1beta1.Coin {
	if x != nil {
		return x.Amount
	}
	return nil
...
var file_cosmos_protocolpool_v1_budget_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x1a, 0x1e, 0x63,
	...
	0x6f, 0x73, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x86, 0x01, 0x0a,
	0x0a, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x46, 0x75, 0x6e, 0x64, 0x73, 0x12, 0x45, 0x0a, 0x11, 0x72,
	...
	0x73, 0x73, 0x12, 0x31, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01,
...
var file_cosmos_protocolpool_v1_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_cosmos_protocolpool_v1_budget_proto_goTypes = []interface{}{
	...
	(*ClaimFunds)(nil),                   // 2: cosmos.protocolpool.v1.ClaimFunds
	(*v1beta1.Coin)(nil),                 // 3: cosmos.base.v1beta1.Coin
}
var file_cosmos_protocolpool_v1_budget_proto_depIdxs = []int32{
	3, // 0: cosmos.protocolpool.v1.MsgSetBudgetProposal.total_budget:type_name -> cosmos.base.v1beta1.Coin
	3, // 1: cosmos.protocolpool.v1.ClaimFunds.amount:type_name -> cosmos.base.v1beta1.Coin
