...
* [#19349](https://github.com/cosmos/cosmos-sdk/pull/19349) Simplify state management in `x/gov`. Note `k.InactiveProposalsQueue`, `k.ActiveProposalsQueue`, `k.VotingPeriodProposals`, `k.DeleteProposal` and `k.SetProposal` are no longer needed and have been removed.
